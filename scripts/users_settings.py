perform_analysis = 1   # 1/2/3   #1 - goes through fodlers in parent folder, takes '*.xtc', '*tpr' from there, calculates correlation functions, timescales, spin relaxation time
                                 #2 - user inserts '*.xtc' and '*.tpr' files, code calculates correlation functions, timescales, spin relaxation times
                                 #3 - user inserts folder path with timescale yaml files, code calculates spin relaxation times    
