    ...
    for filen in os.listdir(us.parent_folder_path):
        ...
        for system in us.systems:
            if fnmatch.fnmatch(os.fsdecode(filen), "*"+system+"*"):
                ...
                timescale_return = nm2.get_timescales_for_system(correlations_path,us.OP,us.smallest_corr_time,us.biggest_corr_time, us.N_exp_to_fit,us.analyze,us.output_path_timescales,output_name,save_yaml=True,save_txt=us.save_timescales_txt)
